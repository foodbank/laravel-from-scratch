...
return [
            ...
            's3' => [
                ...
                */
                'buckets' => [
                    ...
                    'foodbank-cdn' => ['public/css', 'public/js', 'public/images'],
                    // examples:
                ...
                */
                'cloudfront' => [
                    'use' => env('AWS_CDN_USE_CLOUDFRONT'),
    ...
    */
    'include' => [
        'directories' => ['public/css', 'public/js', 'public/images'],
        'extensions' => [],
        'patterns' => [],
    ],
